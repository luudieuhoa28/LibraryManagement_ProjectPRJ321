...
<html>
    ...
    <c:set var="errorRegister" value="${requestScope.ERROR_ACCOUNT}"/>
        <form action="MainController" method="POST">
            ...
            Password: <input type="password" name="password" value="${requestScope.PASSWORD_VALUE}" maxlength="50"/></br>
            Password again: <input type="password" name="rePassword" value="${requestScope.RE_PASSWORD_VALUE}" maxlength="50"/></br>
